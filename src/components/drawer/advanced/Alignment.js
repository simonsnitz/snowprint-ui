    ...
    return (
        <Box sx={{display: 'flex', flexDirection: 'column'}}>
            ...
            <Box sx={{display: 'flex', flexWrap: 'wrap'}}>
                ...
                <NumberButton label="Alignment match" callBack={dispatch} field={'alignMatch'} min={1} max={100} starter={2} />
                <NumberButton label="Alignment mismatch" callBack={dispatch} field={'alignMismatch'} min={-100} max={1} starter={-0.5} />
            </Box>
        </Box>
    )
}